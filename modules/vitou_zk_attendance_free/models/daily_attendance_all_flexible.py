...
class ZkMachineAttendanceFlexible(models.Model):
    ...
    device_id_num = fields.Many2one(comodel_name='vitouzkf.set.device', string='Device ID', help="The ID of the Biometric Device", store=True)
    ...
    devicename = fields.Char(related='device_id_num.name', string="Device Name",store=True)
    device_ip = fields.Char(related='device_id_num.device_ip',string="Device IP",store=True)

    device_in_out = fields.Selection(related='device_id_num.device_in_out',
